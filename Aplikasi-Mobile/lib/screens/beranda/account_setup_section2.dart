...
import 'user_profile_state.dart'; // Import state management

// account_setup_section.dart - Updated Section
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        ...
        // Jika profil sudah lengkap, return empty container
        if (_profileState.isProfileComplete) {
          return const SizedBox.shrink();
        }
        
        // Jika profil belum lengkap, tampilkan section
        return Container(
          margin: const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
          child: Column(
            ...
            children: [
              Expanded(
                child: _buildSetupStep(
                  ...
                  isCompleted: _profileState.userName.isNotEmpty,
                ),
              ),
              ...
              Expanded(
                child: _buildSetupStep(
                  ...
                  isCompleted: _profileState.userClass.isNotEmpty,
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildSetupStep(
                  ...
                  isCompleted: _profileState.schedulePreferences.isNotEmpty,
                ),
              ),
            ],
          ),
...
// Account Setup Page - Updated dengan save profile
...
class _AccountSetupPageState extends State<AccountSetupPage>
  ...
  // Updated _completeSetup method in AccountSetupPage
void _completeSetup() async {
  try {
    ...
    // Simpan profil menggunakan UserProfileState
    await UserProfileState().saveProfile(
      name: _nameController.text.trim(),
      className: _selectedClass,
      schedulePrefs: _selectedSchedulePreferences,
    );
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                'Profil Anda telah berhasil disimpan dan dapat diakses dari beranda.',
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                // Return to landing page with profile complete
                Navigator.of(context).pop();
              },
